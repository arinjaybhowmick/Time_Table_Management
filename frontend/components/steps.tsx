            ...
            return (
              <li key={stepIdx} className="relative flex w-full items-center">
                <button
                  ...
                  className={cn(
                    "group flex w-full cursor-pointer flex-row items-center gap-x-3 rounded-large py-2.5", // Changed from flex-col to flex-row
                    stepClassName,
                  )}
                ...
                >
                  ...
                  {stepIdx < steps.length - 1 && !hideProgressBars && (
                    <div
                      aria-hidden="true"
                      className="pointer-events-none absolute bottom-0 w-full flex-none items-center"
                      style={{
                        // @ts-ignore
                        "--idx": stepIdx,
                      }}
                    >
                      <div
                        className={cn(
                          "relative w-0.5 h-full bg-[var(--inactive-bar-color)] transition-colors duration-300",
                          "after:absolute after:block after:w-full after:h-0 after:bg-[var(--active-border-color)] after:transition-[height] after:duration-300 after:content-['']",
                          {
